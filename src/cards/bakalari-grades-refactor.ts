...
import styles from "./bakalari-grades-refactor/styles";
import "./bakalari-grades-refactor/subject-card";
import "./bakalari-grades-refactor/recent-item";
import {
  groupMarksBySubject,
  getSubjectsSensorNames,
} from "./bakalari-grades-refactor/subject-utils";
import { createPersist } from "./bakalari-grades-refactor/persist";
import { formatDateTime, safeNum as formatSafeNum } from "./shared/format";
import { customElement, property, state } from "lit/decorators.js";
import { repeat } from "lit/directives/repeat.js";

export const CARD_VERSION = "0.3.0";
export const CARD_TYPE = "bakalari-grades-refactor";
export const CARD_NAME = "Bakaláři – Všechny známky - refactor";
...
import type { AnyObj, RecentMark } from "./bakalari-grades-refactor/subject-utils";
...
export class BakalariGradesAllCardRefactor extends LitElement {
  ...
  static getConfigForm() {
    return {
      schema: [
        ...
        { name: "entity_new", selector: { entity: {} } },
  ...
  render() {
    ...
    // TODO: Fix total cout.
    //       we have to calculate total counts. Marks are in separate sensors and total count is not provided by AllMarksSubject sensor.
    //
...
declare global {
  interface HTMLElementTagNameMap {
    [CARD_TYPE]: BakalariGradesAllCardRefactor;
  }
}
